...
func create_server(player_nickname):
	...
	self_data.inhabitants = get_parent().get_node("InterfaceA/Bars/InhabitantsBar").current_inhabitants
	self_data.air = get_parent().get_node("InterfaceA/Bars/AirBar").current_air
	self_data.energy = get_parent().get_node("InterfaceA/Bars/EnergyBar").current_energy
